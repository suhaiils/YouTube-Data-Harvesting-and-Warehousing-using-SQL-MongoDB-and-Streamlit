...
#API key connection
def Api_connect():
    Api_Id="AIzaSyCFGygJ6TGn7xOsna_xONDnCCNQqhIFj-U"
...
#MongoDB Connection
client = pymongo.MongoClient("mongodb+srv://suhaiil:suhaiil@cluster0.b5ya42r.mongodb.net/?retryWrites=true&w=majority")
...
with st.sidebar:
    ...
    st.header("Guvi Capstone Project")
